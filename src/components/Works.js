          ...
          <div className="works-container">
            <div className="works-rows">
              <div className="works-single">
                <a href="https://play.google.com/store/apps/details?id=com.teamgrace.yoda" target="_blank" rel="noreferrer">
                  <div className="works-box">
                    <img className="workimg hvr-shrink" src={Yoda} alt="jupita" />
              ...
              <div className="works-single2">
                ...
                >
                  <div className="works-box">
                    <img className="workimg hvr-shrink" src={YodaMerchant} alt="pms" />
                    <img className="workimg-m" src={YodaMerchant} alt="Yoda-Merchant" />
                  </div>
                </a>
                <div className="works-bottom">
                  <p>REACT-NATIVE, REDUX</p>
            ...
            <div className="works-rows">
              <div className="works-single">
                ...
                >
                  <div className="works-box">
                    <img className="workimg hvr-shrink" src={Podroom} alt="rnm" />
              ...
              <div className="works-single2">
                ...
                >
                  <div className="works-box">
                    <img className="workimg hvr-shrink" src={Aktuarial} alt="aktuarial" />
                    <img className="workimg-m" src={Aktuarialm} alt="aktuarial-m" />
                  </div>
                </a>
                <div style={{backgroundColor: 'black'}} className="works-bottom">
